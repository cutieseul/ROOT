...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 String whereDefault = "SELECT * FROM list where user_uId= '" + uid + "'" ;
...
try{
    ...
    while(rs.next()){
        ...
        tempJson.put("content",rs.getString(2));
        tempJson.put("check",rs.getString(3));
        tempJson.put("uid",rs.getString(4));
